...
from drivlme.inference import drivlme_infer
...
def run_inference(args):
    ...
    for sample in tqdm(gt_contents):
        ...
        try:
            ...
            output_1 = drivlme_infer(video_frames, question_1, conv_mode, model, vision_tower,
            ...
            output_2 = drivlme_infer(video_frames, question_2, conv_mode, model, vision_tower,
                                             tokenizer, image_processor, video_token_len)
