...
def main():
    ...
    for i, content in tqdm(enumerate(input_json_contents)):
        if  not os.path.exists(os.path.join("feat/activity_clip-14L_spatio_temporal_356",f"{content['video_id']}.pkl")):
